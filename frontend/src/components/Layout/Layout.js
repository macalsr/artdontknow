...
import Sketch_bookFormPage from 'pages/CRUD/Sketch_book/form/Sketch_bookFormPage';
import Sketch_bookTablePage from 'pages/CRUD/Sketch_book/table/Sketch_bookTablePage';
    ...
    <div className={classes.root}>
      ...
      >
        ...
        <Switch>
          ...
          <Route
            path={'/admin/sketch_book'}
            exact
            component={Sketch_bookTablePage}
          />
          <Route
            path={'/admin/sketch_book/new'}
            exact
            component={Sketch_bookFormPage}
          />
          <Route
            path={'/admin/sketch_book/:id/edit'}
            exact
            component={Sketch_bookFormPage}
          />
        </Switch>
